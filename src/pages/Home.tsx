  ...
  return (
    <div className="min-h-screen bg-[#f5f0e8]">
      <main className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-hero">
        ...
        <div className="relative z-10 -mt-6 text-center max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
          ...
          >
            ...
            <p className="text-xl sm:text-2xl lg:text-3xl text-black mb-4 font-bold min-h-[2.5rem]">
            ...
            >
              <Button
                className="bg-blue-600 hover:bg-blue-700 text-white text-lg px-12 py-6 rounded-lg font-bold shadow-2xl transition-all duration-300 transform"
