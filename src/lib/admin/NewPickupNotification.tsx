...
export function NewPickupNotification({ request, onAccept, isAlarmPlaying }: Props) {
  ...
  // Check if verified phone is different from user phone
  const hasDifferentPhones = request.verified_phone && request.verified_phone !== request.user_phone;
          ...
          <div className="space-y-4 my-4">
            ...
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-4 rounded-lg border border-blue-200">
              ...
              <div className="space-y-2">
                ...
                {/* Show verified phone with badge */}
                {request.verified_phone && (
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-slate-600">
                      {hasDifferentPhones ? 'Verified Phone:' : 'Phone:'}
                    </span>
                ...
                {/* Show original phone only if different */}
                {hasDifferentPhones && (
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-slate-600">Original Phone:</span>
                ...
                {/* If no verified phone, show user phone */}
                {!request.verified_phone && (
                  <div className="flex justify-between items-center">
